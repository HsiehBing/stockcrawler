...
#######################        
    ...
    #font  'SimHei'
        ...
        fig, axlist = mpf.plot(stock, type='candle', style=s, ylabel='', title = stockNameE, mav = (5,10, 20,60), volume=True,returnfig = True,savefig = 'send.png')
        axlist[0].set_title(stockNameE, fontsize=25, fontfamily='Microsoft JhengHei', loc='center')
    ...
    #font  'SimHei'
        s = mpf.make_mpf_style(base_mpf_style='yahoo', marketcolors=mc, rc = {'font.family':'SimHei'})
        fig, axlist = mpf.plot(stock, type='candle', style=s, ylabel='', title = StockName, mav = (5,10, 20,60), volume=True,returnfig = True,savefig = 'send.png')
        axlist[0].set_title(stockNameE, fontsize=25, fontfamily='Microsoft JhengHei', loc='center')
